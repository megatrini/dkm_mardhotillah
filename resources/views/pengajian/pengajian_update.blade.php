...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form method="post" action="/pengajian/{{ $data['id'] }}">
                @csrf 
                @method('put')
                <div class="mb-3">
                    <label for="tanggal">Tanggal</label>
                    <input type="text" class="form-control" id="tanggal" name="tanggal" aria-describedby="emailHelp"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="materi" name="materi" aria-describedby="emailHelp"
                        placeholder="Materi" value="{{ $data['materi'] }}">
                </div>
                <div class="mb-3">
                    <label for="penceramah">Penceramah</label>
                    <input type="text" class="form-control" id="penceramah" name="penceramah" placeholder="Penceramah"
                        value="{{ $data['penceramah'] }}">
                </div>
