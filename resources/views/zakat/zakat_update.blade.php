...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form method="post" action="/zakat/{{ $data['id'] }}">
                @csrf 
                @method('put')
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="jml_tanggungan" name="jml_tanggungan"
                        placeholder="Jumlah Tanggungan" value="{{ $data['jml_tanggungan'] }}">
                </div>
