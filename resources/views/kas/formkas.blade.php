        ...
        <div class="card-body">
            ...
            <form method="post" action="/kas">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="keterangan" name="keterangan" aria-describedby="emailHelp" placeholder="Keterangan">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="pengeluaran" name="pengeluaran" aria-describedby="emailHelp" placeholder="Pengeluaran">
                </div>
                <div class="mb-3">
